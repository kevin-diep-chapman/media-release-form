...
return [
    ...
    */
    ...
    'loginRoute' => env('SAML2_LOGIN_URL', '/my-events'),
    ...
    */
    ...
    'errorRoute' => env('SAML2_ERROR_URL', '/login'),
    ...
    */
    ...
    'organization' => [
        'en-US' => [
            'name' => env('SAML2_ORGANIZATION_NAME', 'Chapman University'),
            'displayname' => env('SAML2_ORGANIZATION_NAME', 'Chapman Media'),
            'url' => env('SAML2_ORGANIZATION_URL', 'https://www.chapman.edu'),
        ],
    ],
